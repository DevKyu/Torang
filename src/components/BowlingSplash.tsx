...
const BowlingSplash = ({ onComplete }: BowlingSplashProps) => {
  ...
  const ballStartOffsetX =
    trajectory === 'left' ? -22 : trajectory === 'right' ? 22 : 0;

  const ballDriftX =
    trajectory === 'left' ? -142 : trajectory === 'right' ? 142 : 0;
  ...
  const isScattered =
    (phase === 'impact' || phase === 'fadeout') && trajectory === 'center';
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          initial={{
            x: -BALL_SIZE / 2 + ballStartOffsetX,
            y: ballStartY,
          }}
          animate={{
            x: isAfterRolling
              ? -BALL_SIZE / 2 + ballDriftX
              : -BALL_SIZE / 2 + ballStartOffsetX,
